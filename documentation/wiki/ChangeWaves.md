...
- [XmlPeek, XmlPoke, and XslTransformation default to prohibiting embedded DTDs; set MSBUILDDISABLEFEATURESFROMVERSION=18.10 to opt out.](https://github.com/dotnet/msbuild/pull/14285)
