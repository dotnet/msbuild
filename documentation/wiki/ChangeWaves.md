...
- Out-of-proc node read loop (worker nodes and .NET TaskHosts) uses a larger buffered read stream and pre-buffers large packet bodies into memory before deserializing, ensuring fewer pipe reads.
