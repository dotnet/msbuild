...
## Marking AI-Generated GitHub Activity

When you post to GitHub on a user's behalf — replying to or resolving PR review comments, adding PR/issue comments, or submitting a review — the content is published under the user's account and is indistinguishable from something they wrote themselves. As a courtesy to the PR author and other reviewers, clearly mark this content as AI-generated.

* Applies whenever a request resembles "read the comments on this PR and address/respond to them", "reply to this review thread", "leave a comment on the issue", or similar.
* Append this footer as the final line of every comment, reply, or review body you post:

  ```markdown
  _🤖 This response was generated by an AI agent on behalf of the account owner._
  ```

* Keep the marker even when asked to be brief; do not omit or soften it.
* This applies only to content published to GitHub, not to replies inside the local chat session.
