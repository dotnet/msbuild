...
Interested in .NET Core + ASP.NET Core 1.0 bits?
----------------------------------------

This toolchain is independent from the DNX-based .NET Core + ASP.NET Core 1.0 bits. If you are looking for .NET Core + ASP.NET Core 1.0 bits, you can find instructions on the http://get.asp.net/.  
