...
@"{
  ...
  ""two"": ""two""
        ...
        public void It_publishes_projects_with_simple_dependencies_with_filter_profile()
        {
            ...
            depsJson["libraries"][$"Newtonsoft.Json/{ToolsetInfo.NewtonsoftJsonPackageVersion()}"]["runtimeStoreManifestName"].ToString().Should().Be($"{manifestFileName1};{manifestFileName2}");
