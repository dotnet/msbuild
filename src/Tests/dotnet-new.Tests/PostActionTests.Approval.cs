...
namespace Microsoft.DotNet.Cli.New.IntegrationTests
{
    ...
    public partial class PostActionTests : BaseIntegrationTest
    {
        ...
        public Task Restore_Basic_Approval()
        {
            ...
            InstallTestTemplate(_testAssetsManager.CopyTestAsset("", testAssetSubdirectory: $"{DotnetNewTestTemplatesBasePath}/{"PostActions/RestoreNuGet/Basic"}").WithSource().Path, _log, home, workingDirectory);
        ...
        public Task RunScript_Basic_Approval()
        {
            ...
            string home = CreateTemporaryFolder(folderName: "Home");
            string workingDirectory = CreateTemporaryFolder();
            InstallTestTemplate(_testAssetsManager.CopyTestAsset("", testAssetSubdirectory: $"{DotnetNewTestTemplatesBasePath}/{templateLocation}").WithSource().Path, _log, home, workingDirectory);
