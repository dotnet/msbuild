...
namespace Microsoft.NET.Build.Tests
{
    public class DesignTimeBuildTests : SdkTest
    {
        ...
        public void DesignTimePackageDependenciesAreResolved(string targetFramework)
        {
            ...
            testProject.PackageReferences.Add(new TestPackageReference("Newtonsoft.Json", ToolsetInfo.NewtonsoftJsonPackageVersion(), privateAssets: "All"));
            ...
            getValuesCommand.GetValues()
                .Should()
                .BeEquivalentTo($"Newtonsoft.Json/{ToolsetInfo.NewtonsoftJsonPackageVersion()}", "Humanizer/2.8.26");
        }
