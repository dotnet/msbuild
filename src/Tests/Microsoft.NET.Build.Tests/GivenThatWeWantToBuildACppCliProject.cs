    ...
    public class GivenThatWeWantToBuildACppCliProject : SdkTest
    {
        ...
        public void It_builds_and_runs()
        {
            var testAsset = _testAssetsManager
                ...
                .WithSource()
                .WithProjectChanges((projectPath, project) => AddPackageReference(projectPath, project, "NewtonSoft.Json", ToolsetInfo.NewtonsoftJsonPackageVersion()))
        ...
        public void It_builds_and_runs_with_package_reference()
        {
            ...
            var testAsset = _testAssetsManager
                .CopyTestAsset("NetCoreCsharpAppReferenceCppCliLib")
                .WithSource()
                .WithProjectChanges((projectPath, project) => ConfigureProject(projectPath, project, "NewtonSoft.Json", ToolsetInfo.NewtonsoftJsonPackageVersion(), targetFramework, new string[] { "_EnablePackageReferencesInVCProjects", "IncludeWindowsSDKRefFrameworkReferences" }));
