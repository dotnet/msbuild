...
namespace Microsoft.Build.Tasks
{
    ...
    public class WriteCodeFragment : TaskExtension
    {
        ...
        /// available. For example, "C#", "VisualBasic", "F#".
        ...
        private string GenerateCode(out string extension)
        {
            ...
            // F# doesn't support codedom, so the code is manually generated.
            if (Language.ToLowerInvariant() == "f#")
            {
                return GenerateCodeFSharp(out extension);
            }
        ...
        private string GenerateCodeCoreClr(out string extension)
        {
            ...
            switch (Language.ToLowerInvariant())
            {
                ...
                case "vb":
                    ...
                    break;
                case "f#":
                    var fsharpCode = GenerateCodeFSharp(out extension);
                    haveGeneratedContent = !string.IsNullOrEmpty(fsharpCode);
                    code.Append(fsharpCode);
                    break;
                default:
        ...
        private string GenerateCodeFSharp(out string extension)
        {
            extension = "fs";
            if (AssemblyAttributes == null) return string.Empty;
            ...
            code.AppendLine("//------------------------------------------------------------------------------");
            code.AppendLine();
            code.AppendLine("namespace FSharp");
            code.AppendLine();
        ...
        // F# string quoting matches C# for the scenarios covered here
