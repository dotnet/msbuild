...
internal sealed partial record RequestNodesMessage
{
    /// <summary>
    ///  Flags describing which capability-gated fields are present in a <see cref="RequestNodesMessage"/> payload.
    /// </summary>
    /// <remarks>
    ...
    internal enum ExtendedFields : byte
    {
        ...
        /// <summary>
        ///  The payload includes a <see cref="CoordinatorBuildPriority"/> because both peers advertised the
        ///  <see cref="Capabilities.Priority"/> capability.
        /// </summary>
        Priority = 1 << 0,
    }
}
