...
namespace Microsoft.Build.Framework
{
    ...
    /// and environment variables. Implemented as a singleton since it has no instance state and delegates
    /// all operations to the actual system environment.
    /// </summary>
    public class StubTaskEnvironmentDriver : ITaskEnvironmentDriver
    {
        /// <summary>
