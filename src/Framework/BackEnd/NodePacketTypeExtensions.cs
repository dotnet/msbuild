...
internal static class NodePacketTypeExtensions
{
    ...
    /// 6: Added the file-access-reporting flag to TaskHostConfiguration.
    /// 
    ...
    /// <summary>
    /// The minimum negotiated packet version that carries the file-access-reporting flag in
    /// <see cref="NodePacketType.TaskHostConfiguration"/>.
    /// </summary>
    public const byte FileAccessReportingConfigurationMinVersion = 6;
