...
namespace Microsoft.Build.Shared
{
    ...
    internal class FileMatcher
    {
        ...
        private static readonly Lazy<ConditionalWeakTable<
            ConcurrentDictionary<string, IReadOnlyList<string>>,
            Lazy<ConcurrentDictionary<string, object>>>> s_cacheAssociatedLocks = new();
        ...
        private readonly Lazy<ConcurrentDictionary<string, object>> _cachedGlobExpansionsLock;
        ...
        private readonly Func<bool> _shouldObserveDirectoryTraversal;

        internal Action TestOnlyBeforeGetOrAdd { get; set; }
            ...
            Func<bool> shouldObserveDirectoryTraversal = null)
        {
            ...
            else
            {
                ...
                if (_cachedGlobExpansions is not null)
                {
                    _cachedGlobExpansionsLock = s_cacheAssociatedLocks.Value.GetValue(
                        _cachedGlobExpansions,
                        static _ => new Lazy<ConcurrentDictionary<string, object>>(
        ...
        internal static FileMatcher CreateForEvaluation(
            IFileSystem fileSystem,
