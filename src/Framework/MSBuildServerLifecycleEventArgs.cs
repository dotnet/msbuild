...
namespace Microsoft.Build.Framework
{
    ...
    /// and render it structurally. It is written to the binary log under its own record kind; binary-log readers
    /// that predate the record kind skip it via the forward-compatible (length-prefixed) record framing.
    /// </summary>
