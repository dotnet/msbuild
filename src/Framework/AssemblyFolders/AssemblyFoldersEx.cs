...
namespace Microsoft.Build.Shared
{
    ...
    internal class AssemblyFoldersEx<TInfo> : IEnumerable<TInfo>
    {
        /// <summary>
        ...
        private readonly Func<RegistryHive, RegistryView, string, string, Version, TInfo> _createInfo;
        ...
        internal AssemblyFoldersEx(
            ...
            Func<RegistryHive, RegistryView, string, string, Version, TInfo> createInfo)
        {
            ...
            using (RegistryKey baseKey = openBaseKey(hive, view))
            {
                ...
                foreach (ExtensionFoldersRegistryKey directoryKey in directoryKeys)
                {
                    ...
                    if (directoryName != null)
                    {
                        ...
                        _directoryNames.Add(_createInfo(hive, view, directoryKey.RegistryKey, directoryName, directoryKey.TargetFrameworkVersion));
                    }
                }
            }
        }
