...
namespace Microsoft.DotNet.NugetSearch
{
    internal class NugetSearchApiParameter
    {
        ...
        {
            var searchTerm = parseResult.GetValueForArgument<string>(ToolSearchCommandParser.SearchTermArgument);
            ...
            var prerelease = parseResult.GetValueForOption<bool>(ToolSearchCommandParser.PrereleaseOption);
        ...
        {
            var valueFromParser = parseResult.GetValueForOption<string>(alias);
