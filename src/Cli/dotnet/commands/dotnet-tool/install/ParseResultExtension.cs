...
namespace Microsoft.DotNet.Tools.Tool.Install
{
    internal static class ParseResultExtension
    {
        ...
        {
            string packageVersion = parseResult.GetValueForOption<string>(ToolInstallCommandParser.VersionOption);
            bool prerelease = parseResult.GetValueForOption<bool>(ToolInstallCommandParser.PrereleaseOption);
