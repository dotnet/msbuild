...
namespace Microsoft.DotNet.Tools.Tool.Restore
{
    internal class ToolRestoreCommand : CommandBase
    {
            ...
            : base(result)
        {
            ...
            _configFilePath = result.GetValueForOption<string>(ToolRestoreCommandParser.ConfigOption);
            _sources = result.GetValueForOption<string[]>(ToolRestoreCommandParser.AddSourceOption);
            _verbosity = Enum.GetName(result.GetValueForOption<VerbosityOptions>(ToolRestoreCommandParser.VerbosityOption));
        }
        ...
        {
            string customFile = _parseResult.GetValueForOption<string>(ToolRestoreCommandParser.ToolManifestOption);
