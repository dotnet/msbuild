...
namespace Microsoft.DotNet.Tools.Remove.ProjectToProjectReference
{
    internal class RemoveProjectToProjectReferenceCommand : CommandBase
    {
            ...
            ParseResult parseResult) : base(parseResult)
        {
            ...
            _arguments = parseResult.GetValueForArgument<IEnumerable<string>>(RemoveProjectToProjectReferenceParser.ProjectPathArgument).ToList().AsReadOnly();
        ...
        public override int Execute()
        {
            ...
            int numberOfRemovedReferences = msbuildProj.RemoveProjectToProjectReferences(
                _parseResult.GetValueForOption<string>(RemoveProjectToProjectReferenceParser.FrameworkOption),
                references);
