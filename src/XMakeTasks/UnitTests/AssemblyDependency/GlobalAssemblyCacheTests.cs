...
namespace Microsoft.Build.UnitTests.ResolveAssemblyReference_Tests
{
    ...
    public sealed class GlobalAssemblyCacheTests : ResolveAssemblyReferenceTestFixture
    {
        ...
        public void VerifySimpleNamev2057020()
        {
            ...
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.None, _runtimeVersion, new Version("2.0.57027"), false, new FileExists(MockFileExists), _getPathFromFusionName, _gacEnumerator, false);
            Assert.NotNull(path);
        ...
        public void VerifySimpleNamev2057020SpecificVersion()
        {
            ...
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.None, _runtimeVersion, new Version("2.0.0"), false, new FileExists(MockFileExists), _getPathFromFusionName, _gacEnumerator, true);
            Assert.NotNull(path);
        ...
        public void VerifySimpleNamev40()
        {
            ...
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.None, _runtimeVersion, new Version("4.0.0"), false, new FileExists(MockFileExists), _getPathFromFusionName, _gacEnumerator, false);
            Assert.NotNull(path);
            Assert.True(path.Equals(system4Path, StringComparison.OrdinalIgnoreCase));
        }
        ...
        public void VerifySimpleNamev40SpecificVersion()
        {
            ...
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.None, _runtimeVersion, new Version("4.0.0"), false, new FileExists(MockFileExists), _getPathFromFusionName, _gacEnumerator, true);
            Assert.NotNull(path);
            Assert.True(path.Equals(system4Path, StringComparison.OrdinalIgnoreCase));
        }
        ...
        public void VerifyFusionNamev40SpecificVersion()
        {
            ...
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.None, _runtimeVersion, new Version("4.0.0.0"), false, new FileExists(MockFileExists), _getPathFromFusionName, _gacEnumerator, true);
            Assert.NotNull(path);
            Assert.True(path.Equals(system4Path, StringComparison.OrdinalIgnoreCase));
        }
        ...
        public void VerifyNullPublicKey()
        {
            ...
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.None, getRuntimeVersion, new Version("2.0.50727"), false, new FileExists(MockFileExists), _getPathFromFusionName, _gacEnumerator, false);
            Assert.Null(path);
        }
        ...
        public void VerifyProcessorArchitectureDoesNotCrash()
        {
            ...
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.MSIL, getRuntimeVersion, new Version("2.0.50727"), false, new FileExists(MockFileExists), _getPathFromFusionName, null /* use the real gac enumerator*/, false);
            Assert.Null(path);
        }
        ...
        {
            AssemblyNameExtension fusionName = new AssemblyNameExtension("System, PublicKeyToken=b77a5c561934e089, ProcessorArchitecture=MSIL");
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.MSIL, getRuntimeVersion, new Version("2.0.50727"), false, new FileExists(MockFileExists), _getPathFromFusionName, null /* use the real gac enumerator*/, true);
            Assert.Null(path);
        }
        ...
        {
            AssemblyNameExtension fusionName = new AssemblyNameExtension("System, PublicKeyToken=b77a5c561934e089, ProcessorArchitecture=MSIL");
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.MSIL, getRuntimeVersion, new Version("2.0.50727"), true, new FileExists(MockFileExists), _getPathFromFusionName, null /* use the real gac enumerator*/, false);
            Assert.Null(path);
        }
        ...
        {
            AssemblyNameExtension fusionName = new AssemblyNameExtension("System, PublicKeyToken=b77a5c561934e089, ProcessorArchitecture=MSIL");
            string path = GlobalAssemblyCache.GetLocation(fusionName, ProcessorArchitecture.MSIL, getRuntimeVersion, new Version("2.0.50727"), true, new FileExists(MockFileExists), _getPathFromFusionName, null /* use the real gac enumerator*/, true);
            Assert.Null(path);
        }
