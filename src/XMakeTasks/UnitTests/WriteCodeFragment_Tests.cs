...
namespace Microsoft.Build.UnitTests
{
    ...
    public class WriteCodeFragment_Tests
    {
        ...
        private static void CheckContent(string actualContent, string[] expectedAttributes, params string[] expectedHeader)
        {
            string expectedContent = string.Join(Environment.NewLine, expectedHeader.Concat(expectedAttributes)) + Environment.NewLine;
