...
namespace Microsoft.DotNet.Publishing.Tasks.MsDeploy
{
    ...
    internal class VSMSDeployObject
    {
      ...
      //<prefetchPayload></prefetchPayload>
        ...
        {
            m_iListProviderOption.Add(new Microsoft.DotNet.Publishing.Tasks.MsDeploy.ProviderOption(factoryName, parameterName, parameterStringValue));
        }

        public void SyncParameter(string parameterName, string parameterStringValue)
        {
            m_iListParameter.Add(new MsDeploy.ParameterInfo(parameterName, parameterStringValue));
        }


        public Generic.IList<MsDeploy.ParameterInfoWithEntry> EntryParameters
        {
