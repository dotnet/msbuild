...
public class NodeBudgetManager_Tests
{
    ...
    public void TryGrant_SingleBuild_GrantsUpToRequestedNodes()
    {
        ...
        BuildGrant grant = new(processId: 1, requestedNodes: 16);
    ...
    {
        NodeBudgetManager manager = new(totalBudget: 16);
        BuildGrant grant = new(processId: 1, requestedNodes: 4);
    ...
    public void TryGrant_BudgetExhausted_QueuesBuilds()
    {
        ...
        BuildGrant grant1 = new(processId: 1, requestedNodes: 4);
        BuildGrant grant2 = new(processId: 2, requestedNodes: 4);
    ...
    public void TryGrant_FairShare_DividesBudgetAmongContenders()
    {
        ...
        NodeBudgetManager manager = new(totalBudget: 16);
        BuildGrant grant1 = new(processId: 1, requestedNodes: 8);
        manager.TryGrant(grant1).ShouldBe(8);

        // Exhaust budget so grant2 queues.
        BuildGrant filler = new(processId: 99, requestedNodes: 8);
        manager.TryGrant(filler).ShouldBe(8);

        BuildGrant grant2 = new(processId: 2, requestedNodes: 16);
    ...
    public void TryGrant_FairShare_WithWaitingBuilds_NewArrivalGetsShare()
    {
        ...
        BuildGrant blocker = new(processId: 1, requestedNodes: 8);
        manager.TryGrant(blocker).ShouldBe(8);

        BuildGrant waiter1 = new(processId: 2, requestedNodes: 8);
        BuildGrant waiter2 = new(processId: 3, requestedNodes: 8);
    ...
    public void TryGrant_MinimumGrantIsOne()
    {
        ...
        BuildGrant grant1 = new(processId: 1, requestedNodes: 1);
    ...
    {
        NodeBudgetManager manager = new(totalBudget: 16);
        BuildGrant grant = new(processId: 1, requestedNodes: 8);
    ...
    {
        NodeBudgetManager manager = new(totalBudget: 4);
        BuildGrant active = new(processId: 1, requestedNodes: 4);
        manager.TryGrant(active);

        BuildGrant waiting = new(processId: 2, requestedNodes: 4);
    ...
    public void Release_DrainsWaitQueue_InFIFOOrder()
    {
        ...
        BuildGrant waiter1 = new(processId: 2, requestedNodes: 4);
        BuildGrant waiter2 = new(processId: 3, requestedNodes: 4);
    ...
    public void Release_DrainsWaitQueue_StopsWhenBudgetExhausted()
    {
        ...
        BuildGrant blocker = new(processId: 1, requestedNodes: 2);
        manager.TryGrant(blocker);

        // Queue three builds that each want 1 node.
        BuildGrant waiter1 = new(processId: 2, requestedNodes: 1);
        BuildGrant waiter2 = new(processId: 3, requestedNodes: 1);
        BuildGrant waiter3 = new(processId: 4, requestedNodes: 1);
        manager.TryGrant(waiter1);
        manager.TryGrant(waiter2);
    ...
    public void MultipleBuilds_FairShare_AccountingStaysConsistent()
    {
        ...
        BuildGrant g1 = new(processId: 1, requestedNodes: 16);
        BuildGrant g2 = new(processId: 2, requestedNodes: 16);
        BuildGrant g3 = new(processId: 3, requestedNodes: 16);
