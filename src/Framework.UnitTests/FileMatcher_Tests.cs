        ...
        */
        ...
        internal sealed class MockFileSystem
        {
                    ...
                    foreach (string candidate in candidates)
                    {
                        ...
                        if (IsMatchingDirectory(path, normalizedCandidate))
                        {
                            ...
                            if (nextSlash != -1)
                            {
                                ...
                                string match = normalizedCandidate.StartsWith(@"\\", StringComparison.CurrentCulture) && string.IsNullOrEmpty(path)
                                    ? @"\\"
            ...
            internal static string Normalize(string path)
            {
                ...
                // Replace leading UNC.
                if (normalized.StartsWith(@"\\", StringComparison.CurrentCulture))
                {
