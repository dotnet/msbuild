...
namespace Microsoft.TemplateEngine.Cli.Commands
{
    internal class UninstallCommand : BaseCommand<UninstallCommandArgs>
    {
        ...
        protected override Task<int> ExecuteAsync(UninstallCommandArgs args, IEngineEnvironmentSettings environmentSettings, CancellationToken cancellationToken) => throw new NotImplementedException();
