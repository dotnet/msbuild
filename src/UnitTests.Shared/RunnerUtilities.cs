...
namespace Microsoft.Build.UnitTests.Shared
{
    public static class RunnerUtilities
    {
        ...
        public static string ExecBootstrapedMSBuild(
            ...
            int timeoutMilliseconds = 30_000)
        {
            return RunProcessAndGetOutput(BootstrapMSBuildExecutablePath, msbuildParameters, out successfulExit, shellExecute, outputHelper, attachProcessId, timeoutMilliseconds, environmentVariables: GetMSBuildEnvironmentVariables());
        }
