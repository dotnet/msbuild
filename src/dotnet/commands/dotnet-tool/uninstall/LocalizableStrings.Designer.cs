...
namespace Microsoft.DotNet.Cli.commands.uninstall {
    ...
    public class LocalizableStrings {
        ...
        public static string UninstallToolCommandInvalidGlobalAndLocalAndToolPath {
            get {
                return ResourceManager.GetString("UninstallToolCommandInvalidGlobalAndLocalAndToolPath", resourceCulture);
            }
        }
        
        public static string UninstallLocalToolSucceeded {
            get {
                return ResourceManager.GetString("UninstallLocalToolSucceeded", resourceCulture);
            }
        }
