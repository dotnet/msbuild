...
MSBuildTask0012 | MSBuild.TaskAuthoring | Warning | A task constructed inside a multithreadable task does not receive its TaskEnvironment (code fix available)
