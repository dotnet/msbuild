...
namespace Microsoft.Build.Execution
{
    ...
    public class BuildManager : INodePacketHandler, IBuildComponentHost, IDisposable
    {
        ...
        private enum BuildManagerState
        {
            ...
            /// <see cref="BuildManager.PendBuildRequest(Microsoft.Build.Execution.BuildRequestData)"/>, <see cref="BuildManager.BuildRequest(Microsoft.Build.Execution.BuildRequestData)"/>, <see cref="BuildManager.PendBuildRequest(GraphBuildRequestData)"/>, <see cref="BuildManager.BuildRequest(BuildRequestData)"/>, <see cref="BuildManager.BuildRequest(GraphBuildRequestData)"/> and <see cref="BuildManager.EndBuild"/> may be called in this state.
            /// </summary>
            Building,
