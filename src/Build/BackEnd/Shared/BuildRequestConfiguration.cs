...
namespace Microsoft.Build.BackEnd
{
                                               ...
                                               INodePacket
    {
        ...
        /// </summary>
        internal ProjectInstanceUsageScope EnterProjectInstanceUsage()
        {
            lock (_syncLock)
            {
                RetrieveFromCache();
                Assumed.False(IsCached, "Configuration could not be retrieved before accessing the project.");
                _projectInstanceUsageCount++;
                return new ProjectInstanceUsageScope(this);
            }
        }
