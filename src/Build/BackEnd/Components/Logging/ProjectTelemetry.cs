        ...
        public void TrackTaskSubclassing(Type taskType, bool isMicrosoftOwned)
        {
            ...
            while (baseType != null)
            {
                ...
                if (!string.IsNullOrEmpty(baseTypeName) &&
                    (baseTypeName.StartsWith("Microsoft.Build.Tasks.", StringComparison.CurrentCulture) ||
                     baseTypeName.StartsWith("Microsoft.Build.Utilities.", StringComparison.CurrentCulture)))
                {
