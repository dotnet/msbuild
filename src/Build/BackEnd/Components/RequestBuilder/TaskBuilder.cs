        ...
        private async ValueTask<WorkUnitResult> ExecuteInstantiatedTask(TaskExecutionHost taskExecutionHost, TaskLoggingContext taskLoggingContext, TaskHost taskHost, ItemBucket bucket, TaskExecutionMode howToExecuteTask)
        {
            ...
            else
            {
                ...
                catch (LoggerException)
                {
                    ...
                    _continueOnError = ContinueOnError.ErrorAndStop;
                    throw; // Preserves stack trace without wrapping
                }
...
#endif
                    _continueOnError = ContinueOnError.ErrorAndStop;
                    throw; // Cannot wrap ThreadAbortException anyway, direct throw preserves what we can
                }
                ...
                // If we reach here, the task executed successfully without throwing an exception
                taskReturned = true;
