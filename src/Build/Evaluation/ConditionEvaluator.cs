...
namespace Microsoft.Build.Evaluation
{
    internal static class ConditionEvaluator
    {
            ...
            where I : class, IItem
        {
            ...
            // Lock-free pop from pool, or parse a new expression tree if the pool is empty.
            ...
            // Lock the individual expression to prevent concurrent use of its mutable evaluation state.
            // Each thread gets its own expression from the pool (or a freshly parsed one),
            // so contention here only occurs if the same expression was just pushed back and immediately popped.
