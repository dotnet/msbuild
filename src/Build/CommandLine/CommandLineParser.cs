...
namespace Microsoft.Build.CommandLine
{
    public static class CommandLineParser
    {
        ...
        public static IReadOnlyList<string> IncludedResponseFiles => s_includedResponseFiles ?? (IReadOnlyList<string>)Array.Empty<string>();
        ...
        public static void GatherAllSwitches(
#if FEATURE_GET_COMMANDLINE
            string commandLine,
#else
            string[] commandLine,
#endif
            out CommandLineSwitches switchesFromAutoResponseFile, out CommandLineSwitches switchesNotFromAutoResponseFile, out string fullCommandLine, out string exeName)
        {
        ...
        /// </remarks>
        public static void GatherCommandLineSwitches(List<string> commandLineArgs, CommandLineSwitches commandLineSwitches, string commandLine = "")
        {
        ...
        public static string ExtractSwitchParameters(
        ...
        /// </summary>
        public static bool GatherAutoResponseFileSwitches(string path, CommandLineSwitches switchesFromAutoResponseFile, string commandLine)
        {
        ...
        public static bool GatherAutoResponseFileSwitchesFromFullPath(string autoResponseFile, CommandLineSwitches switchesFromAutoResponseFile, string commandLine)
        {
            bool found = false;
        ...
        public static void ResetGatheringSwitchesState()
        {
        ...
        public static int GetLengthOfSwitchIndicator(string unquotedSwitch)
        {
