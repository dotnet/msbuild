...
namespace Microsoft.Build.Execution
{
    ...
    internal class ReflectableTaskPropertyInfo : TaskPropertyInfo
    {
        ...
        internal ReflectableTaskPropertyInfo(TaskPropertyInfo taskPropertyInfo, Type taskType)
            : base(taskPropertyInfo.Name, taskPropertyInfo.PropertyType, taskPropertyInfo.Output, taskPropertyInfo.Required, taskPropertyInfo.IsPathLike)
        {
        ...
        internal ReflectableTaskPropertyInfo(PropertyInfo propertyInfo)
            ...
            !propertyInfo.GetCustomAttributes(typeof(NotPathLikeAttribute), true).Any())
        {
        ...
        /// </summary>
        internal ReflectableTaskPropertyInfo(PropertyInfo propertyInfo, bool output, bool required, bool isAssignableToITaskItemType, bool isFileLike)
            : base(
            propertyInfo.Name,
            propertyInfo.PropertyType,
            output,
