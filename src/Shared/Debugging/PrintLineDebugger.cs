...
namespace Microsoft.Build.Shared.Debugging
{
    ...
    internal sealed class PrintLineDebugger : IDisposable
    {
        ...
        public static void SetWriter(CommonWriterType writer)
        {
            ...
            {
                InternalError.Throw("Cannot set a new writer over an old writer. Remove the old one first");
            }
        ...
        private void ReleaseUnmanagedResources()
        {
            if (_writerSetByThisInstance != null)
            {
                ...
                {
                    InternalError.Throw($"The writer from this {nameof(PrintLineDebugger)} instance differs from the static writer.");
                }
