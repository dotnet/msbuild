...
namespace Microsoft.Build.UnitTests.GenerateResource_Tests.InProc
{
    ...
    sealed public class TransformationErrors
    {
        ...
        /// </summary>
        [Fact]
        [SkipOnTargetFramework(TargetFrameworkMonikers.Netcoreapp, ".NET Core MSBuild doesn't support reading from .resources")]
    ...
    public class References
    {
        ...
        public void DontLockP2PReferenceWhenResolvingSystemTypes()
        {
            ...
            ObjectModelHelpers.BuildTempProjectFileExpectSuccess("lib1.csproj", _output);
        ...
        public void ReferencedAssemblySpecifiedUsingRelativePath()
        {
            ...
            ObjectModelHelpers.BuildTempProjectFileExpectSuccess("ClassLibrary20.csproj", _output);
