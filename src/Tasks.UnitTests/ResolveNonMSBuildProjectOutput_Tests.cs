...
namespace Microsoft.Build.UnitTests
{
    sealed public class ResolveNonMSBuildProjectOutput_Tests
    {
        ...
        public void TestUnresolvedReferences()
        {
            ...
            Assert.Empty(resolvedOutputs.Count); // "No resolved refs expected for case 1"
            ...
            Assert.Single(resolvedOutputs.Count); // "One resolved ref expected for case 2"
            Assert.True(resolvedOutputs.ContainsKey(@"obj\correct.dll"));
            Assert.Single(unresolvedOutputs.Count); // "One unresolved ref expected for case 2"
            Assert.Equal(unresolvedOutputs["MCDep1.vcproj"], projectRefs[0]);
            ...
            Assert.Empty(unresolvedOutputs.Count); // "No unresolved refs expected for case 3"
            ...
            Assert.Empty(resolvedOutputs.Count); // "No resolved refs expected for case 4"
            Assert.Empty(unresolvedOutputs.Count); // "No unresolved refs expected for case 4"
            ...
            Assert.Single(resolvedOutputs.Count); // "One resolved ref expected for case 5"
            Assert.True(resolvedOutputs.ContainsKey(@"obj\correct.dll"));
            Assert.Empty(unresolvedOutputs.Count); // "No unresolved refs expected for case 5"
            ...
            Assert.Empty(resolvedOutputs.Count); // "No resolved refs expected for case 6"
            Assert.Single(unresolvedOutputs.Count); // "One unresolved ref expected for case 6"
            Assert.Equal(unresolvedOutputs["MCDep2.vcproj"], projectRefs[1]);
        }
