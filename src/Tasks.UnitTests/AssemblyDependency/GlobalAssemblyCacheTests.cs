...
namespace Microsoft.Build.UnitTests.ResolveAssemblyReference_Tests
{
    ...
    public sealed class GlobalAssemblyCacheTests : ResolveAssemblyReferenceTestFixture
    {
        ...
        public void SystemRuntimeDepends_No_Build()
        {
            ...
            Assert.Equal("false", t.DependsOnSystemRuntime); //                 "Expected no System.Runtime dependency found during build."
            Assert.Equal("false", t.DependsOnNETStandard); //                   "Expected no netstandard dependency found during build."
            ...
            Assert.Equal("false", t.DependsOnSystemRuntime); //                 "Expected no System.Runtime dependency found during intellibuild."
            Assert.Equal("false", t.DependsOnNETStandard); //                   "Expected no netstandard dependency found during intellibuild."
        }
        ...
        public void SystemRuntimeDepends_Yes()
        {
            ...
            Assert.Equal("true", t.DependsOnSystemRuntime); //                 "Expected System.Runtime dependency found during build."
            ...
            Assert.Equal("true", t.DependsOnSystemRuntime); //                 "Expected System.Runtime dependency found during intellibuild."
        }
        ...
        public void NETStandardDepends_Yes()
        {
            ...
            Assert.Equal("true", t.DependsOnNETStandard); //                 "Expected System.Runtime dependency found during build."
            ...
            Assert.Equal("true", t.DependsOnNETStandard); //                 "Expected System.Runtime dependency found during intellibuild."
        }
        ...
        public void NETStandardDepends_Yes_Indirect()
        {
            ...
            Assert.Equal("true", t.DependsOnNETStandard); //                 "Expected netstandard dependency found during build."
            ...
            Assert.Equal("true", t.DependsOnNETStandard); //                 "Expected netstandard dependency found during intellibuild."
        }
