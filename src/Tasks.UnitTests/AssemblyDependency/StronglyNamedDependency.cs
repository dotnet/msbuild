...
namespace Microsoft.Build.UnitTests.ResolveAssemblyReference_Tests.VersioningAndUnification.Prerequisite
{
    public sealed class StronglyNamedDependency : ResolveAssemblyReferenceTestFixture
    {
        ...
        public void VerifyAssemblyPulledOutOfFrameworkDoesntGetFrameworkFileAttribute()
        {
            ...
            ResolveAssemblyReference t1 = new ResolveAssemblyReference(TaskEnvironment.Fallback);
            ...
            ResolveAssemblyReference t2 = new ResolveAssemblyReference(TaskEnvironment.Fallback);
            ...
            ResolveAssemblyReference t3 = new ResolveAssemblyReference(TaskEnvironment.Fallback);
            ...
            ResolveAssemblyReference t4 = new ResolveAssemblyReference(TaskEnvironment.Fallback);
