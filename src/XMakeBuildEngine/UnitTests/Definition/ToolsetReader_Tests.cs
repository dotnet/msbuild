...
namespace Microsoft.Build.UnitTests.Definition
{
    ...
    public class ToolsetReaderTests : IDisposable
    {
        ...
        public void GetToolsetDataFromConfiguration_Basic()
        {
            ...
            Assert.Equal(@"D:\windows\Microsoft.NET\Framework\v2.0.x86ret", values["2.0"].ToolsPath);
            Assert.Equal(0, values["4.0"].Properties.Count);
            Assert.Equal(@"D:\windows\Microsoft.NET\Framework\v4.0.x86ret", values["4.0"].ToolsPath);
        }
        ...
        public void BlankPropertyValueInRegistrySubToolset()
        {
            ...
            Assert.Equal("2.0", defaultToolsVersion);
            Assert.Equal(0, values["2.0"].Properties.Count);
            Assert.Equal(@"c:\someBinPath", values["2.0"].ToolsPath);
        ...
        public void GetToolsetData_NoConflict()
        {
            ...
            Assert.Equal(@"D:\somepath", values["2.0"].ToolsPath);
            Assert.Equal(@"D:\somepath2", values["4.0"].ToolsPath);
            Assert.Equal(@"D:\windows\Microsoft.NET\Framework\v2.0.x86ret", values["4.5"].ToolsPath);
            Assert.Equal(@"D:\windows\Microsoft.NET\Framework\v4.0.x86ret", values["5.0"].ToolsPath);
        }
        ...
        public void PropertiesInRegistryCannotReferToOtherPropertiesInRegistry()
        {
            ...
            Assert.Equal("c:\\x", values["2.0"].ToolsPath);
        }
        ...
        public void NoInterferenceBetweenToolsetDefinitions()
        {
            ...
            Assert.Equal(@"D:\20\some\folder\on\disk", values["2.0"].ToolsPath);
            Assert.Equal(2, values["2.0"].Properties.Count);
            ...
            Assert.Equal(@"D:\35\some\folder\on\disk", values["4.0"].ToolsPath);
        ...
        public void GetToolsetData_ConflictingPropertyValuesSameCase()
        {
            ...
            Assert.Equal(1, values.Count);
            Assert.Equal(0, values["2.0"].Properties.Count);
            Assert.Equal(@"D:\somedifferentpath", values["2.0"].ToolsPath);
        }
        ...
        public void GetToolsetData_NoMerging()
        {
            ...
            Assert.Equal(1, values.Count);
            Assert.Equal(1, values["2.0"].Properties.Count);
            Assert.Equal(@"D:\someotherpath", values["2.0"].ToolsPath);
        ...
        public void SetOverrideTasks_SpecifiedOnlyInRegistry()
        {
            ...
            Assert.Equal("4.0", defaultToolsVersion);
            Assert.Equal("c:\\TaskOverridePath", values["4.0"].OverrideTasksPath);
