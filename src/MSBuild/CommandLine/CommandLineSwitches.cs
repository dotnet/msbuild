...
namespace Microsoft.Build.CommandLine.Experimental
{
    ...
    internal sealed class CommandLineSwitches
    {
        ...
        private static readonly ParameterizedSwitchInfo[] s_parameterizedSwitchesMap =
        {
            ...
            new ParameterizedSwitchInfo(  ["replayfilter"],                     ParameterizedSwitch.ReplayFilter,               "DuplicateReplayFilter",        false,          "MissingReplayFilter",                 true,   false,   "HelpMessage_53_ReplayFilterSwitch"),
