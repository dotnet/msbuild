                    ...
                    else
                    {
                       ...
                       if (System.Enum.TryParse<MsDeploy.Utility.IISExpressMetadata>(name, out expressMetadata))
                       {
                           ...
                           if (!string.IsNullOrEmpty(value))
                           {
                               ...
                               {
                                   case Microsoft.DotNet.Publish.Tasks.MsDeploy.Utility.IISExpressMetadata.WebServerAppHostConfigDirectory:
                                       msdeploy.WebServerAppHostConfigDirectory = value;
                                       break;
                                   case Microsoft.DotNet.Publish.Tasks.MsDeploy.Utility.IISExpressMetadata.WebServerDirectory:
                                       msdeploy.WebServerDirectory = value;
                                       break;
                                   case Microsoft.DotNet.Publish.Tasks.MsDeploy.Utility.IISExpressMetadata.WebServerManifest:
