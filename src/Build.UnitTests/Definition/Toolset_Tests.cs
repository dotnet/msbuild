    ...
    public class Toolset_Tests
    {
        ...
        public void Regress27993_TrailingSlashTrimmedFromMSBuildToolsPath()
        {
            ...
            foreach ((string pathValue, string expectedPath) in testCases)
            {
                ...
                Assert.AreEqual(expectedPath, t.ToolsPath);
            }
        }
        ...
        public void ValidateToolsetTranslation()
        {
            ...
            Assert.IsNotNull(t2.ImportPropertySearchPathsTable);
            Assert.ContainsSingle(t2.ImportPropertySearchPathsTable);
            Assert.AreEqual(@"c:\foo", t2.ImportPropertySearchPathsTable["MSBuildExtensionsPath"].SearchPaths[0]);
        }
        ...
        public void TestDefaultSubToolsetFor40()
        {
            ...
            if (t != null)
            {
                ...
                Assert.IsTrue(defaultSubToolset == null || Version.TryParse(defaultSubToolset, out _), 
