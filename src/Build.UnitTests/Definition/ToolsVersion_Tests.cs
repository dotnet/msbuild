...
namespace Microsoft.Build.UnitTests.Definition
{
    public class ToolsetState_Tests
    {
        ...
        public void OverrideTasksAreFoundInOverridePath()
        {
            ...
            {
                Assert.True(taskRegistry.TaskRegistrations.ContainsKey(new TaskRegistry.RegisteredTaskIdentity(expectedRegisteredTask, new TaskHostParameters())),
            ...
            {
                Assert.True(taskoverrideRegistry.TaskRegistrations.ContainsKey(new TaskRegistry.RegisteredTaskIdentity(expectedRegisteredTask, new TaskHostParameters())),
                              String.Format("Expected task '{0}' registered!", expectedRegisteredTask));
            }

            foreach (string unexpectedRegisteredTask in unexpectedRegisteredTasks)
            {
                Assert.False(taskRegistry.TaskRegistrations.ContainsKey(new TaskRegistry.RegisteredTaskIdentity(unexpectedRegisteredTask, new TaskHostParameters())),
            ...
            {
                Assert.False(taskoverrideRegistry.TaskRegistrations.ContainsKey(new TaskRegistry.RegisteredTaskIdentity(unexpectedRegisteredTask, new TaskHostParameters())),
                              String.Format("Unexpected task '{0}' registered!", unexpectedRegisteredTask));
            }
        }
