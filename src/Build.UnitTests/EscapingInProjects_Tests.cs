...
namespace Microsoft.Build.UnitTests.EscapingInProjects_Tests
{
    ...
    public class SimpleScenarios : IDisposable
    {
        ...
        public SimpleScenarios(TestContext testOutputHelper)
        {
        ...
        public void ModifyItemIncludeEscapedSemicolon()
        {
            ...
            try
            {
                ...
                Assert.ContainsSingle(newItems);
    ...
    public class FullProjectsUsingMicrosoftCommonTargets
    {
        ...
        public FullProjectsUsingMicrosoftCommonTargets(TestContext output)
        {
            _testOutput = output;
        }
        ...
        /// </summary>
        [MSBuildTestMethod]
        [Ignore("This is a known issue in Roslyn. This test should be enabled if Roslyn is updated for this scenario.")]
