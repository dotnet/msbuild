...
{
    public class StaticGraph_Tests
    {
        [Theory]
        ...
        public void ExportTargetsShouldGetExecutedOnlyDuringIsolatedProjectBuilds(bool isIsolatedProjectBuild, string[] expectedBuildResultTargets, string[] expectedExecutedTargets)
        {
            ...
            using (var buildManager = new BuildManager())
            {
                ...
                var buildResult = buildManager.Build(
                    ...
                    new BuildRequestData(
                        ...
                        new string[]{},
                        null,
                        isIsolatedProjectBuild ? BuildRequestDataFlags.IsolatedProjectBuild : BuildRequestDataFlags.None
                        ));

                buildResult.OverallResult.ShouldBe(BuildResultCode.Success);

                buildResult.ResultsByTarget.Keys.OrderBy(_ => _).ShouldBe(expectedBuildResultTargets.OrderBy(_ => _));
