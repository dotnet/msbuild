...
namespace Microsoft.Build.UnitTests.BackEnd
{
    ...
    public class TaskBuilder_Tests : ITargetBuilderCallback
    {
        ...
        public void TasksOnlyLogStartedEventOnceEach()
        {
            ...
            int count = 0;
            for (int index = results.IndexOf("Task \"Message\"", StringComparison.CurrentCulture); index >= 0; index = results.IndexOf("Task \"Message\"", index, StringComparison.CurrentCulture))
            {
                count++;
