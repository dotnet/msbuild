...
");
        ...
        [Theory]
        [InlineData(null, null, (int)VisualStudioMultiThreadedMode.Off)]
        [InlineData("", null, (int)VisualStudioMultiThreadedMode.Off)]
        [InlineData("unknown", null, (int)VisualStudioMultiThreadedMode.Off)]
