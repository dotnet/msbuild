...
namespace Microsoft.Build.UnitTests.BackEnd
{
    ...
    public sealed class OnError_Tests
    {
        ...
        public void Basic()
        {
            ...
            Assert.True(l.FullLog.Contains("CleanUp-was-called", StringComparison.CurrentCulture)); // "The CleanUp target should have been called."
        }
        ...
        public void TwoExecuteTargets()
        {
            ...
            Assert.Equal(1, l.ErrorCount); // "Expected one error because 'Build' failed."
            Assert.True(l.FullLog.Contains("CleanUp-was-called", StringComparison.CurrentCulture)); // "The CleanUp target should have been called."
            Assert.True(l.FullLog.Contains("CleanUp2-was-called", StringComparison.CurrentCulture)); // "The CleanUp2 target should have been called."
        }
        ...
        public void ErrorInChildIsHandledInParent()
        {
            ...
            Assert.True(l.FullLog.Contains("CleanUp-was-called", StringComparison.CurrentCulture)); // "The CleanUp target should have been called."
            Assert.True(l.FullLog.Contains("Error-in-build-step-1", StringComparison.CurrentCulture)); // "The BuildStep1 target should have been called."
        }
        ...
        public void NonExistentExecuteTarget()
        {
            ...
            Assert.False(l.FullLog.Contains("CleanUp-was-called", StringComparison.CurrentCulture)); // "The CleanUp target should not have been called."
        }
        ...
        public void ErrorTargetsContinueAfterErrorsInErrorHandler()
        {
            ...
            Assert.True(l.FullLog.Contains("CleanUp1-was-called", StringComparison.CurrentCulture)); // "The CleanUp1 target should have been called."
            Assert.True(l.FullLog.Contains("CleanUp2-was-called", StringComparison.CurrentCulture)); // "The CleanUp2 target should have been called."
            Assert.True(l.FullLog.Contains("CleanUp3-was-called", StringComparison.CurrentCulture)); // "The CleanUp3 target should have been called."
        }
...
<Project>
    ...
    <Target Name=""MyTarget"">
        ...
        public void PostBuildBasic()
        {
            ...
            Assert.True(l.FullLog.Contains("ResGen-was-called", StringComparison.CurrentCulture)); // "The ResGen target should have been called."
            Assert.True(l.FullLog.Contains("Compile-was-called", StringComparison.CurrentCulture)); // "The Compile target should have been called."
            Assert.True(l.FullLog.Contains("GenerateSatellites-was-called", StringComparison.CurrentCulture)); // "The GenerateSatellites target should have been called."
            Assert.True(l.FullLog.Contains("PostBuild-was-called", StringComparison.CurrentCulture)); // "The PostBuild target should have been called."
        }
        ...
        public void PostBuildOnSuccessWhereCompileFailed()
        {
            ...
            Assert.True(l.FullLog.Contains("ResGen-was-called", StringComparison.CurrentCulture)); // "The ResGen target should have been called."
            Assert.True(l.FullLog.Contains("Compile-was-called", StringComparison.CurrentCulture)); // "The Compile target should have been called."
            Assert.True(l.FullLog.Contains("Compile-step-failed", StringComparison.CurrentCulture)); // "The Compile target should have failed."
            Assert.False(l.FullLog.Contains("GenerateSatellites-was-called", StringComparison.CurrentCulture)); // "The GenerateSatellites target should not have been called."
            Assert.False(l.FullLog.Contains("PostBuild-was-called", StringComparison.CurrentCulture)); // "The PostBuild target should not have been called."
        }
        ...
        public void PostBuildOnSuccessWhereGenerateSatellitesFailed()
        {
            ...
            Assert.True(l.FullLog.Contains("Compile-was-called", StringComparison.CurrentCulture)); // "The Compile target should have been called."
            Assert.True(l.FullLog.Contains("GenerateSatellites-was-called", StringComparison.CurrentCulture)); // "The GenerateSatellites target should have been called."
            Assert.True(l.FullLog.Contains("GenerateSatellites-step-failed", StringComparison.CurrentCulture)); // "The GenerateSatellites target should have failed."
            Assert.False(l.FullLog.Contains("PostBuild-was-called", StringComparison.CurrentCulture)); // "The PostBuild target should not have been called."
        }
