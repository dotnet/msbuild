...
namespace Microsoft.Build.UnitTests
{
    public class XMakeAppTests : IDisposable
    {
        ...
        public void VersionSwitch()
        {
            ...
            output.EndsWith(Environment.NewLine, StringComparison.CurrentCulture).ShouldBeTrue();
        ...
        public void VersionSwitchDisableChangeWave()
        {
            ...
            string output = process.StandardOutput.ReadToEnd();
            output.EndsWith(Environment.NewLine, StringComparison.CurrentCulture).ShouldBeFalse();
