...
$script:CommentPrefix = "> [!NOTE]`n> This comment was generated by GitHub Copilot CLI."
...
function Add-CommentPrefix {
    ...
    if ($normalizedBody.StartsWith($script:CommentPrefix, [System.StringComparison]::Ordinal)) {
        return $Body
    }

    return "$script:CommentPrefix`n`n$Body"
}
