...
$script:CopilotCommentPrefix = "> [!NOTE]`n> This comment was generated by GitHub Copilot CLI."

function Add-CopilotCommentPrefix {
    param([AllowEmptyString()][string] $Body)

    $normalizedBody = $Body.Replace("`r`n", "`n")
    if ($normalizedBody.StartsWith($script:CopilotCommentPrefix, [System.StringComparison]::Ordinal)) {
        return $Body
    }

    return "$script:CopilotCommentPrefix`n`n$Body"
}
