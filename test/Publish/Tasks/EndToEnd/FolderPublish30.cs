...
{
    public class FolderPublish30
    {
        public string BaseTestDirectory
        {
            get
            {
                return Path.Combine(AppContext.BaseDirectory, nameof(FolderPublish30));
            }
        }
        ...
        public FolderPublish30(ITestOutputHelper testOutputHelper)
        {
        ...
        [Theory]
        [InlineData("netcoreapp3.0", "Release", "core", "none", "false")]
        [InlineData("netcoreapp3.0", "Debug", "core", "none", "false")]
        [InlineData("netcoreapp3.0", "Release", "core", "Individual", "false")]
        [InlineData("netcoreapp3.0", "Debug", "core", "Individual", "false")]
        [InlineData("netcoreapp3.0", "Release", "core", "Individual", "true")]
        [InlineData("netcoreapp3.0", "Debug", "core", "Individual", "true")]
        ...
        [Theory]
        [InlineData("netcoreapp3.0", "Release", "core", "net461")]
        [InlineData("netcoreapp3.0", "Debug", "core", "net461")]

        //[InlineData("netcoreapp3.0", "Release", "core", "net462")]
        //[InlineData("netcoreapp3.0", "Debug", "core", "net462")]
        ...
        [Theory]
        [InlineData("netcoreapp3.0", "Release", "core", "none", "false", "net461")]
        [InlineData("netcoreapp3.0", "Debug", "core", "none", "false", "net461")]
        [InlineData("netcoreapp3.0", "Release", "core", "Individual", "false", "net461")]
        [InlineData("netcoreapp3.0", "Debug", "core", "Individual", "false", "net461")]
        [InlineData("netcoreapp3.0", "Release", "core", "Individual", "true", "net461")]
        [InlineData("netcoreapp3.0", "Debug", "core", "Individual", "true", "net461")]

        //[InlineData("netcoreapp3.0", "Release", "core", "none", "false", "net462")]
        //[InlineData("netcoreapp3.0", "Debug", "core", "none", "false", "net462")]
        //[InlineData("netcoreapp3.0", "Release", "core", "Individual", "false", "net462")]
        //[InlineData("netcoreapp3.0", "Debug", "core", "Individual", "false", "net462")]
        //[InlineData("netcoreapp3.0", "Release", "core", "Individual", "true", "net462")]
        //[InlineData("netcoreapp3.0", "Debug", "core", "Individual", "true", "net462")]
