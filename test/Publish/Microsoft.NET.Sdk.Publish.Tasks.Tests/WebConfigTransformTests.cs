      ...
      <system.webServer>
        ...
        public void WebConfigTransform_creates_new_config_if_one_does_not_exist()
        {
            Assert.True(XNode.DeepEquals(WebConfigTemplate,
                    WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName:null)));

            Assert.True(XNode.DeepEquals(WebConfigTemplatePortable,
                    WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: false, extension: null, aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)));
        }
        ...
        public void WebConfigTransform_creates_ProcessPath_WithCorrectExtension()
        {
            ...
            Assert.True(XNode.DeepEquals(WebConfigTemplateWithOutExe,
                    WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: true, extension: null, aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)));
        }
        ...
        {
            Assert.True(XNode.DeepEquals(WebConfigTemplate,
                WebConfigTransform.Transform(XDocument.Parse("<unexpected />"), "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)));
        }
        ...
        public void WebConfigTransform_adds_missing_elements(string[] elementNames)
        {
            ...
            Assert.True(XNode.DeepEquals(WebConfigTemplate,
                WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)));
        }
        ...
        public void WebConfigTransform_wont_override_custom_values(string elementName, string attributeName, string attributeValue)
        {
            ...
            var output = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null);
        ...
        public void WebConfigTransform_will_UseHostingModel_FromWebConfigIfPresent(string elementName, string attributeName, string attributeValue)
        {
            ...
            var output = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: "foo", environmentName: null);
            Assert.Equal(attributeValue, (string)output.Descendants(elementName).Single().Attribute(attributeName));
        }
        ...
        {
            var output = WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: attributeValue, aspNetCoreHostingModel: null, environmentName: null);
            Assert.Equal(attributeValue, (string)output.Descendants(elementName).Single().Attribute(attributeName));
        }
        ...
        {
            var output = WebConfigTransform.Transform(WebConfigTemplate, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: attributeValue, aspNetCoreHostingModel: null, environmentName: null);
        ...
        public void WebConfigTransform_UsingAspNetCoreModule_SupportsOutOfProc(string elementName, string attributeName, string attributeValue)
        {
            ...
            var output = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: attributeValue, environmentName: null);
            Assert.Equal(attributeValue, (string)output.Descendants(elementName).Single().Attribute(attributeName));
        }
        ...
        public void WebConfigTransform_Throws_ForInValidHostingModel(string attributeValue)
        {
            ...
            Assert.Throws<Exception>(() => WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: attributeValue, environmentName: null));
        }
        ...
        {
            var output = WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: aspNetCoreModuleName, aspNetCoreHostingModel: attributeValue, environmentName: null);
            Assert.Equal(attributeValue, (string)output.Descendants(elementName).Single().Attribute(attributeName));
        }
        ...
        public void WebConfigTransform_Throws_IfHostingModelValueIsUndefined(string attributeValue)
        {
            ...
            Assert.Throws<Exception>(() => WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: attributeValue, environmentName: null));
        }
        ...
        public void WebConfigTransform_will_append_Env_IfPassed()
        {
            ...
            var output = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: "Production");
        ...
        public void WebConfigTransform_will_Override_Env_IfUpdated()
        {
            ...
            var output = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: "Staging");
        ...
        {
            var newProcessPath =
                (string)WebConfigTransform.Transform(WebConfigTemplate, "app.exe", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)
        ...
        public void WebConfigTransform_does_not_remove_children_of_aspNetCore_element()
        {
            ...
            Assert.True(XNode.DeepEquals(envVarElement,
                WebConfigTransform.Transform(input, "app.exe", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: "Test")
                    .Descendants("environmentVariable").SingleOrDefault(e => (string)e.Attribute("name") == "ENVVAR")));

            var output = WebConfigTransform.Transform(input, "app.exe", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: "Test");
        ...
        public void WebConfigTransform_adds_stdoutLogEnabled_if_attribute_is_missing()
        {
            ...
            Assert.Equal(
                "false",
                (string)WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)
        ...
        public void WebConfigTransform_correctly_configures_for_Azure()
        {
            ...
            var aspNetCoreElement = WebConfigTransform.Transform(input, "test.dll", configureForAzure: true, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)
        ...
        {
            var input = WebConfigTemplate;
            var output = WebConfigTransform.Transform(input, "test.dll", configureForAzure: true, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null);
        ...
        public void WebConfigTransform_configures_portable_apps_correctly()
        {
            var aspNetCoreElement =
                WebConfigTransform.Transform(WebConfigTemplate, "test.dll", configureForAzure: false, useAppHost: false, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)
                    .Descendants("aspNetCore").Single();
        ...
        {
            var aspNetCoreElement =
                WebConfigTransform.Transform(WebConfigTemplate, "test.exe", configureForAzure: false, useAppHost: false, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)
                    .Descendants("aspNetCore").Single();
        ...
        public void WebConfigTransform_wont_override_existing_args_for_portable_apps(string inputArguments, string outputArguments)
        {
            ...
            var aspNetCoreElement =
                WebConfigTransform.Transform(input, "myapp.dll", configureForAzure: false, useAppHost: false, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null)
                    .Descendants("aspNetCore").Single();
        ...
        {
            // Arrange
            XDocument transformedWebConfig = WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModule: null, aspNetCoreHostingModel: null, environmentName: null);
