...
xcopy \\aspnetci\share\tools\websdk\sign.proj "%WebSdkTools%" /y /C
xcopy \\aspnetci\share\tools\websdk\WebDeploy\* "%WebSdkTools%\WebDeploy\*" /y /C /e /s /f

msbuild "%WebSdkRoot%\build.proj" /p:configuration=Release /p:SkipInvalidConfigurations=true /t:Build;Sign;Publish
